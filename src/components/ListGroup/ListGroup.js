...
function ListGroup(props) {
    return (
        <div>
            <Col size="xs-12 sm-12 med-4 lg-4">
            ...
            <Col size="xs-12 sm-12 md-8 lg-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-readme" role="tabpanel" aria-labelledby="list-readme-list">
                        <img id="img" src="https://github.com/charlinelach/responsivePortfolio/blob/master/Images/screenshotREADME.gif" alt="GIF of README app use" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-portfolio" role="tabpanel" aria-labelledby="list-portfolio-list">
                        <img id="img" src="https://github.com/charlinelach/responsivePortfolio/blob/master/Images/portfolioScreenshot.png" alt="Contact UI Screenshot" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-yogaPlan" role="tabpanel" aria-labelledby="list-yogaPlan-list">
                        <img id="img" src="https://github.com/charlinelach/yogaPlan/blob/main/images/cardio.png" alt="Cardio Screenshot" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-pw" role="tabpanel" aria-labelledby="list-pw-list">
                        <img id="img" src="https://github.com/charlinelach/responsivePortfolio/blob/master/Images/pw.gif" alt="Contact UI Screenshot" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-btProject" role="tabpanel" aria-labelledby="list-btProject-list">
                        <img id="img" src="https://github.com/ShueMoua/Budget_Tracker/blob/main/public/images/budgetGIF.gif" alt="Budget Tracker GIF" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-novelfilms" role="tabpanel" aria-labelledby="list-novelfilms-list">
                        <img id="img" src="https://github.com/charlinelach/responsivePortfolio/blob/master/Images/goosebumpsScreenshot.jpg" alt="NovelFilms Screenshot" width="100%" />
