...
import Col from "../Col";
import "./style.css";
import budgetGIF from "./images/budgetGIF.gif";
import cardio from "./images/cardio.png";
import goosebumpsScreenshot from "./images/goosebumpsScreenshot.jpg";
import portfolioScreenshot from "./images/portfolioScreenshot.png";
import pw from "./images/pw.gif";
import read from "./images/screenshotREADME.gif";
            ...
            <Col size="xs-12 sm-12 md-8 lg-8">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="list-pw" role="tabpanel" aria-labelledby="list-pw-list">
                        <img id="img" src={pw} alt="Contact UI Screenshot" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-btProject" role="tabpanel" aria-labelledby="list-btProject-list">
                        <img id="img" src={budgetGIF} alt="Budget Tracker GIF" width="100%" />
                    ...
                    <div class="tab-pane fade" id="list-novelfilms" role="tabpanel" aria-labelledby="list-novelfilms-list">
                        <img id="img" src={goosebumpsScreenshot} alt="NovelFilms Screenshot" width="100%" />
