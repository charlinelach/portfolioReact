            ...
            <Col size="md-8 lg-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-readme" role="tabpanel" aria-labelledby="list-readme-list">
                        <img src="./Images/screenshotREADME.gif" alt="GIF of README app use" width="100%" style="height:auto; float:left; margin: 1%;" />
                    ...
                    <div class="tab-pane fade" id="list-portfolio" role="tabpanel" aria-labelledby="list-portfolio-list">
                        <img src="./Images/portfolioScreenshot.png" alt="Contact UI Screenshot" width="100%" style="height:auto; float:left; margin: 1%;" />
                    ...
                    <div class="tab-pane fade" id="list-yogaPlan" role="tabpanel" aria-labelledby="list-yogaPlan-list">
                        <img src="./Images/pw.gif" alt="Contact UI Screenshot" width="100%" style="height:auto; float:left; margin: 1%;" />
                    ...
                    <div class="tab-pane fade" id="list-btProject" role="tabpanel" aria-labelledby="list-btProject-list">
                        <img src="./Images/goosebumpsScreenshot.jpg" alt="Budget Tracker GIF" width="100%" style="height:auto; float:left; margin: 1%;" />
                    ...
                    <div class="tab-pane fade" id="list-novelfilms" role="tabpanel" aria-labelledby="list-novelfilms-list">
                        <img src="./Images/goosebumpsScreenshot.jpg" alt="NovelFilms Screenshot" width="100%" style="height:auto; float:left; margin: 1%;" />
